...
class Hacklemore(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        upper_bb, mid_bb, lower_bb = ta.BBANDS(dataframe['close'], timeperiod=20)
        ...
        dataframe['breakout-low'] = np.where(dataframe['low'] <= dataframe['lower-bb'], True, False)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Normal buy triggers that apply to new trades we want to enter
            ...
            conditions.append(
                ...
                (dataframe['breakout-low-last'] >= 2) &
                (dataframe['breakout-low-last'] <= 10) &
            ...
            # if there are other open trades consider their performance before we enter a new position
            if trade_data['other_trades']:
                conditions.append(trade_data['avg_other_profit'] >= 0)
